  ...
  return (
    <div className={`flex h-screen font-sans overflow-hidden ${themeClasses.bg}`}>
        ...
        <div className="flex flex-col flex-1 h-screen min-w-0 relative">
            {/* Header */}
            <header className={`p-4 shadow-sm flex flex-col sm:flex-row justify-between items-center z-20 border-b transition-colors duration-300 no-print ${themeClasses.header}`}>
            ...
            <footer className={`p-4 no-print bg-white/80 backdrop-blur-md border-t border-slate-200`}>
                ...
                {stagedFiles.length > 0 && (
                    <div className={`max-w-4xl mx-auto p-3 mb-3 border rounded-xl ${themeClasses.stagedFiles}`}>
                ...
                <form onSubmit={handleSubmit} className="flex items-end max-w-4xl mx-auto gap-2 bg-white rounded-2xl shadow-lg border border-slate-200 p-2 focus-within:ring-2 focus-within:ring-offset-2 transition-all duration-300 input-area relative overflow-hidden">
